...
type Basket struct {
	...
	SubscriptionFee       float64 `gorm:"default:0" json:"subscriptionFee"`       // Monthly fee
	YearlySubscriptionFee float64 `gorm:"default:0" json:"yearlySubscriptionFee"` // Yearly fee
